...
export const PricingConfig = {
  ...
  cards: [
    {
      ...
      price: '$0',
      period: '',
      desc: 'For small schools or to try out our platform.',
      features: [
    ...
    },
    {
      ...
      period: '',
      badge: 'Most Popular',
      desc: 'For growing schools that need more power and features.',
      features: [
    ...
    },
    {
      title: 'Enterprise',
      price: 'Custom',
      desc: 'For large schools or districts with custom needs.',
      features: [
  ...
  schoolDesc: 'Join a growing community of innovative schools transforming their administration',
  schoolLogos: [
  ...
  principalFeedBack: "Edusphere has transformed our school's efficiency. The attendance tracking and communication tools have saved us countless hours.",
