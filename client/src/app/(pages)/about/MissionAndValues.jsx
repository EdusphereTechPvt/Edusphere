...
export default function MissionAndValues() {
  const cards = [
    {
      ...
      styles: {
        cardStyle: { inlineStyle: { px: 4, width: 500, height: {xs:150, md:220} } },
        ...
        textContainerStyle: {
          ...
          descStyle: {
            inlineStyle: {
              fontSize: { xs: "0.6rem", sm: "0.8rem", lg: "0.9rem" },
            },
          },
        },
      },
  ...
  return (
    <section className="py-10 lg:py-20 px-6 text-center bg-gray-100">
