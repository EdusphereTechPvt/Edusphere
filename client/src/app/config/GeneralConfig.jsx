    ...
    sections: [
      {
        ...
        styles: {
          ...
          imgStyle: {
            inlineStyle: {
              // width: { xs: "0.4rem", lg: "8rem" },
              // height: { xs: "0.5rem", lg: "8rem" },
            },
    ...
    sections: [
      {
        ...
        name: "",
        description:
          "Transforming education through innovative school management solutions that streamline administration, enhance learning, and connect communities.",
        contactInfo: {
        ...
        styles: {
          ...
          logoStyle: {
            ...
            className: "xs:w-[90px] md:w-[180px]",
          },
          nameStyle: {
            fontSize: "1.75rem",
            fontWeight: "bold",
